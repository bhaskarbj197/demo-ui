...
export class AdvisorValidationResultDataService {
  ...
  getValidationResultAsync(journalId: journalIdType, runDate: string): Observable<HttpResponse<any>> {
    return this.dataService.getAsync(this.constantLoaderService.relativeUrlsService.ADVR_GET_VALIDATION_RESULT
